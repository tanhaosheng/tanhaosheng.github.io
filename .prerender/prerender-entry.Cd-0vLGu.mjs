import { a as fileExtension, f as removeLeadingForwardSlash, h as trimSlashes, i as collapseDuplicateTrailingSlashes, l as joinPaths, m as slash, n as collapseDuplicateLeadingSlashes, o as hasFileExtension, p as removeTrailingForwardSlash, r as collapseDuplicateSlashes, s as isInternalPath, t as appendForwardSlash, u as prependForwardSlash } from "./chunks/path_Bkwe9UF8.mjs";
import { $ as LocalsNotAnObject, A as DEFAULT_404_COMPONENT, B as ActionNotFoundError, D as isRoute500, E as isRoute404, F as fetchStateSymbol, G as ForbiddenRewrite, H as AstroResponseHeadersReassigned, I as originPathnameSymbol, J as GetStaticPathsInvalidRouteParam, L as pipelineSymbol, M as REROUTABLE_STATUS_CODES, N as appSymbol, O as ASTRO_ERROR_HEADER, P as clientAddressSymbol, Q as InvalidGetStaticPathsReturn, R as responseSentSymbol$1, S as isAstroComponentFactory, U as CacheNotEnabled, V as ActionsReturnedInvalidDataError, W as ClientAddressNotAvailable, Y as GetStaticPathsRequired, Z as InvalidGetStaticPathsEntry, at as PrerenderClientAddressNotAvailable, b as normalizeCspResourceEntry, ct as ResponseSentError, d as renderTemplate, dt as SessionStorageSaveError, et as LocalsReassigned, f as decodeKey, ft as StaticClientAddressNotAvailable, ht as i18nNoLocaleFoundInPath, i as renderComponent, it as PageNumberParamNotFound, j as REDIRECT_STATUS_CODES, k as ASTRO_GENERATOR, l as renderSlotToString, lt as RewriteWithBodyUsed, m as generateCspDigest, n as renderPage, nt as MiddlewareNotAResponse, o as chunkToString, ot as PrerenderDynamicEndpointPathCollide, p as decryptString, pt as UnableToLoadLogger, q as GetStaticPathsExpectedParams, r as renderJSX, rt as NoMatchingStaticPathFound, s as createSlotValueFromString, st as ReservedSlotName, tt as MiddlewareNoDataOrNextCalled, u as isRenderTemplateResult, ut as SessionStorageInitError, w as renderEndpoint, x as pushDirective, y as isRenderInstruction, z as AstroError } from "./chunks/server_C5Sh4yOg.mjs";
...
function deserializeActionResult(res) {
	if (res.type === "error") {
		...
		if (Object.assign({
			...
			"SSR": true
		}, { _: "/Users/xx/Desktop/aitoolstack_v2/node_modules/.bin/astro" })?.PROD) return {
...
function serializeActionResult(res) {
	if (res.error) {
		if (Object.assign({
			...
			"SITE": "https://tanhaosheng.github.io",
			"SSR": true
		}, { _: "/Users/xx/Desktop/aitoolstack_v2/node_modules/.bin/astro" })?.DEV) actionResultErrorStack.set(res.error.stack);
		let body2;
...
var _page0 = () => import("./chunks/404_Ck0n98Ff.mjs");
var _page1 = () => import("./chunks/about_CC_OKwEK.mjs");
var _page2 = () => import("./chunks/contact_DP2eCL-J.mjs");
var _page3 = () => import("./chunks/news_GRmNRrLu.mjs");
var _page4 = () => import("./chunks/privacy_Du6_24Q3.mjs");
var _page5 = () => import("./chunks/category-_category__Cb6Qk0vp.mjs");
var _page6 = () => import("./chunks/_slug__CJYe4tf7.mjs");
var _page7 = () => import("./chunks/index_CT9Nqhwd.mjs");
var pageMap = /* @__PURE__ */ new Map([
	...
	["src/pages/category-[category].astro", _page5],
	["src/pages/[slug].astro", _page6],
	["src/pages/index.astro", _page7]
]);
//#endregion
//#region \0virtual:astro:manifest
var _manifest = deserializeManifest({"rootDir":"file:///Users/xx/Desktop/aitoolstack_v2/","cacheDir":"file:///Users/xx/Desktop/aitoolstack_v2/node_modules/.astro/","outDir":"file:///Users/xx/Desktop/aitoolstack_v2/dist/","srcDir":"file:///Users/xx/Desktop/aitoolstack_v2/src/","publicDir":"file:///Users/xx/Desktop/aitoolstack_v2/public/","buildClientDir":"file:///Users/xx/Desktop/aitoolstack_v2/dist/client/","buildServerDir":"file:///Users/xx/Desktop/aitoolstack_v2/dist/server/","adapterName":"","assetsDir":"_astro","routes":[{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/BaseLayout.TV0LIaHY.css"}],"routeData":{"route":"/404","isIndex":false,"type":"page","pattern":"^\\/404\\/?$","segments":[[{"content":"404","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/404.astro","pathname":"/404","prerender":true,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/BaseLayout.TV0LIaHY.css"}],"routeData":{"route":"/about","isIndex":false,"type":"page","pattern":"^\\/about\\/?$","segments":[[{"content":"about","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/about.astro","pathname":"/about","prerender":true,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/BaseLayout.TV0LIaHY.css"}],"routeData":{"route":"/contact","isIndex":false,"type":"page","pattern":"^\\/contact\\/?$","segments":[[{"content":"contact","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/contact.astro","pathname":"/contact","prerender":true,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/BaseLayout.TV0LIaHY.css"}],"routeData":{"route":"/news","isIndex":false,"type":"page","pattern":"^\\/news\\/?$","segments":[[{"content":"news","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/news.astro","pathname":"/news","prerender":true,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/BaseLayout.TV0LIaHY.css"}],"routeData":{"route":"/privacy","isIndex":false,"type":"page","pattern":"^\\/privacy\\/?$","segments":[[{"content":"privacy","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/privacy.astro","pathname":"/privacy","prerender":true,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/BaseLayout.TV0LIaHY.css"}],"routeData":{"route":"/category-[category]","isIndex":false,"type":"page","pattern":"^\\/category-([^/]+?)\\/?$","segments":[[{"content":"category-","dynamic":false,"spread":false},{"content":"category","dynamic":true,"spread":false}]],"params":["category"],"component":"src/pages/category-[category].astro","prerender":true,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"inline","content":":root{--primary:#6c3ce1;--primary-dark:#4f2db5;--accent:#f59e0b;--bg:#f5f7fa;--text:#1a1a2e;--text-light:#6b7280;--border:#e5e7eb;--card:#fff}.hero-wrap{max-width:840px;margin:0 auto;padding:20px 20px 0}.hero-img{border:1px solid var(--border);border-radius:14px;width:100%;height:auto;display:block;box-shadow:0 8px 28px #6c3ce12e}*{box-sizing:border-box;margin:0;padding:0}body{background:var(--bg);color:var(--text);max-width:800px;margin:0 auto;padding:0 20px;font-family:-apple-system,BlinkMacSystemFont,Segoe UI,Roboto,sans-serif;font-size:20px;line-height:1.8}a{color:var(--primary);text-decoration:none}h1{color:var(--primary);margin:30px 0 20px;font-size:28px;line-height:1.3}h2{color:var(--primary-dark);margin:30px 0 15px;font-size:22px}h3{color:var(--primary-dark);margin:20px 0 10px;font-size:18px}p{margin-bottom:16px}ul,ol{margin:0 0 16px 22px}li{margin-bottom:8px}table{border-collapse:collapse;width:100%;margin:20px 0;font-size:16px}th,td{border:1px solid var(--border);text-align:left;padding:12px}th{background:#f3f4f6}tr:nth-child(2n){background:#f9fafb}.box{border-left:4px solid var(--accent);background:#fff3cd;border-radius:4px;margin:20px 0;padding:16px}.takeaways{background:var(--card);border:1px solid var(--border);border-radius:8px;margin:20px 0;padding:18px 22px}.takeaways h3{color:var(--primary);margin-top:0}.takeaways li{margin-bottom:6px}.features{margin:20px 0;padding:0;list-style:none}.features li{border-bottom:1px solid #e5e7eb;padding:8px 0}.features li:last-child{border-bottom:none}.verdict{border:2px solid var(--primary);background:#ede9fe;border-radius:12px;margin:24px 0;padding:20px}.verdict strong{color:var(--primary-dark)}.faq{margin:20px 0}.faq details{border:1px solid var(--border);background:var(--card);border-radius:8px;margin-bottom:10px;padding:12px 16px}.faq summary{cursor:pointer;color:var(--primary-dark);font-weight:700}.faq p{margin:10px 0 0}.pill{background:var(--primary);color:#fff;border-radius:999px;margin-bottom:10px;padding:3px 10px;font-size:13px;display:inline-block}.site-footer{color:#ffffffb3;text-align:center;background:#1a1a2e;margin-top:60px;padding:36px 0;font-size:14px;line-height:1.7}.site-footer a{color:#fffc;margin:0 8px}@media (width<=600px){body{font-size:16px}h1{font-size:24px}}\n"}],"routeData":{"route":"/[slug]","isIndex":false,"type":"page","pattern":"^\\/([^/]+?)\\/?$","segments":[[{"content":"slug","dynamic":true,"spread":false}]],"params":["slug"],"component":"src/pages/[slug].astro","prerender":true,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/BaseLayout.TV0LIaHY.css"}],"routeData":{"route":"/","isIndex":true,"type":"page","pattern":"^\\/$","segments":[],"params":[],"component":"src/pages/index.astro","pathname":"/","prerender":true,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}}],"serverLike":false,"middlewareMode":"classic","site":"https://tanhaosheng.github.io","base":"/","trailingSlash":"ignore","compressHTML":"jsx","componentMetadata":[["/Users/xx/Desktop/aitoolstack_v2/src/pages/404.astro",{"propagation":"none","containsHead":true}],["/Users/xx/Desktop/aitoolstack_v2/src/pages/about.astro",{"propagation":"none","containsHead":true}],["/Users/xx/Desktop/aitoolstack_v2/src/pages/category-[category].astro",{"propagation":"none","containsHead":true}],["/Users/xx/Desktop/aitoolstack_v2/src/pages/contact.astro",{"propagation":"none","containsHead":true}],["/Users/xx/Desktop/aitoolstack_v2/src/pages/index.astro",{"propagation":"none","containsHead":true}],["/Users/xx/Desktop/aitoolstack_v2/src/pages/news.astro",{"propagation":"none","containsHead":true}],["/Users/xx/Desktop/aitoolstack_v2/src/pages/privacy.astro",{"propagation":"none","containsHead":true}],["/Users/xx/Desktop/aitoolstack_v2/src/pages/[slug].astro",{"propagation":"none","containsHead":true}]],"renderers":[],"clientDirectives":[["idle","(()=>{var l=(n,t)=>{let i=async()=>{await(await n())()},e=typeof t.value==\"object\"?t.value:void 0,s={timeout:e==null?void 0:e.timeout};\"requestIdleCallback\"in window?window.requestIdleCallback(i,s):setTimeout(i,s.timeout||200)};(self.Astro||(self.Astro={})).idle=l;window.dispatchEvent(new Event(\"astro:idle\"));})();"],["load","(()=>{var e=async t=>{await(await t())()};(self.Astro||(self.Astro={})).load=e;window.dispatchEvent(new Event(\"astro:load\"));})();"],["media","(()=>{var n=(a,t)=>{let i=async()=>{await(await a())()};if(t.value){let e=matchMedia(t.value);e.matches?i():e.addEventListener(\"change\",i,{once:!0})}};(self.Astro||(self.Astro={})).media=n;window.dispatchEvent(new Event(\"astro:media\"));})();"],["only","(()=>{var e=async t=>{await(await t())()};(self.Astro||(self.Astro={})).only=e;window.dispatchEvent(new Event(\"astro:only\"));})();"],["visible","(()=>{var a=(s,i,o)=>{let r=async()=>{await(await s())()},t=typeof i.value==\"object\"?i.value:void 0,c={rootMargin:t==null?void 0:t.rootMargin},n=new IntersectionObserver(e=>{for(let l of e)if(l.isIntersecting){n.disconnect(),r();break}},c);for(let e of o.children)n.observe(e)};(self.Astro||(self.Astro={})).visible=a;window.dispatchEvent(new Event(\"astro:visible\"));})();"]],"entryModules":{"astro/entrypoints/prerender":"prerender-entry.Cd-0vLGu.mjs","\u0000virtual:astro:page:src/pages/404@_@astro":"chunks/404_Ck0n98Ff.mjs","\u0000astro:data-layer-content":"chunks/_astro_data-layer-content_kr-0TTiH.mjs","\u0000noop-middleware":"chunks/_noop-middleware_CQ50ikAJ.mjs","\u0000virtual:astro:page:src/pages/[slug]@_@astro":"chunks/_slug__CJYe4tf7.mjs","\u0000virtual:astro:server-island-manifest":"chunks/_virtual_astro_server-island-manifest_C1Q2srgE.mjs","\u0000virtual:astro:session-driver":"chunks/_virtual_astro_session-driver_C-PI1Pas.mjs","\u0000virtual:astro:page:src/pages/about@_@astro":"chunks/about_CC_OKwEK.mjs","\u0000virtual:astro:page:src/pages/category-[category]@_@astro":"chunks/category-_category__Cb6Qk0vp.mjs","\u0000virtual:astro:page:src/pages/contact@_@astro":"chunks/contact_DP2eCL-J.mjs","/Users/xx/Desktop/aitoolstack_v2/.astro/content-assets.mjs":"chunks/content-assets_DXqEyLLP.mjs","\u0000virtual:astro:page:src/pages/index@_@astro":"chunks/index_CT9Nqhwd.mjs","\u0000virtual:astro:page:src/pages/news@_@astro":"chunks/news_GRmNRrLu.mjs","\u0000virtual:astro:actions/noop-entrypoint":"chunks/noop-entrypoint_Z3zFhrGC.mjs","\u0000virtual:astro:page:src/pages/privacy@_@astro":"chunks/privacy_Du6_24Q3.mjs","virtual:astro:noop":"_astro/_virtual_astro_noop.SBldSjMi.js","astro:scripts/before-hydration.js":""},"inlinedScripts":[],"assets":["/_astro/BaseLayout.TV0LIaHY.css","/file:///Users/xx/Desktop/aitoolstack_v2/dist/404.html","/file:///Users/xx/Desktop/aitoolstack_v2/dist/about.html","/file:///Users/xx/Desktop/aitoolstack_v2/dist/contact.html","/file:///Users/xx/Desktop/aitoolstack_v2/dist/news.html","/file:///Users/xx/Desktop/aitoolstack_v2/dist/privacy.html","/file:///Users/xx/Desktop/aitoolstack_v2/dist/index.html"],"buildFormat":"file","checkOrigin":false,"actionBodySizeLimit":1048576,"serverIslandBodySizeLimit":1048576,"allowedDomains":[],"key":"gOAYvhd7OHR9iA1wEcRuHm2FpgHTiVgYGEdQXgLZubs=","image":{},"devToolbar":{"enabled":false,"debugInfoOutput":""},"logLevel":"info","shouldInjectCspMetaTags":false});
