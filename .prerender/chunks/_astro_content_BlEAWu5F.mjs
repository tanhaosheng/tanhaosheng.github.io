import { s as createComponent } from "./SiteFooter_BKUJEopM.mjs";
import { c as isRemotePath, d as removeBase } from "./path_Bkwe9UF8.mjs";
import { C as unescapeHTML, d as renderTemplate, m as generateCspDigest, mt as UnknownContentCollectionError, t as spreadAttributes, z as AstroError } from "./server_C5Sh4yOg.mjs";
import "html-escaper";
...
var ImmutableDataStore = class ImmutableDataStore {
	...
	*/
	static async fromModule() {
		try {
			const data = await import("./_astro_data-layer-content_kr-0TTiH.mjs");
